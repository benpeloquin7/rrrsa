#' Three alternatives data from Peloquin and Frank 2016
#'
#' This data set contains empirical literal listener semantics
#' and pragmatic judgments for entailment items (three alternatives) from
#' Peloquin & Frank 2016.
#'
